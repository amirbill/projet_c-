...
void MainWindow::on_pushButton_ajout_ouss_clicked()
{
...
void MainWindow::on_pushButton_annuler_ouss_clicked()
{
    ui->le_id_ouss->clear();
...
void MainWindow::on_pb_supprimer_ouss_clicked()
{
...
void MainWindow::on_pushButton_modif_ouss_clicked()
{
...
void MainWindow::on_pb_recherche_ouss_clicked()
{
           QString search=ui->le_recherche_ouss->text();
           ui->TableView_ouss->setModel(h.Rechercher(search));
}

void MainWindow::on_pushButton_trierid_ouss_clicked()
{
    huissier E;
...
void MainWindow::on_pushButton_trierprenom_ouss_clicked()
{
    huissier h;
...
void MainWindow::on_pushButton_triersalle_ouss_clicked()
{
    huissier h;
...
void MainWindow::on_pushButton_excel_ouss_clicked()
{
    QTableView *table;
...
void MainWindow::on_pushButton_pdf_ouss_clicked()
{
    QSqlQuery query;
...
void MainWindow::on_TableView_ouss_doubleClicked(const QModelIndex &index)
{
...
void MainWindow::on_pushButton_stat_ouss_clicked()
{
