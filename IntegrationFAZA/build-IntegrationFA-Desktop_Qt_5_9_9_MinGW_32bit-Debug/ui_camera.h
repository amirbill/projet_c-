...
public:
    ...
    void setupUi(QDialog *camera)
    {
        ...
        camera->resize(979, 585);
        camera->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
...
""));
        ...
        stackedWidget->setGeometry(QRect(40, 70, 901, 401));
        ...
        QRadialGradient gradient(0.5, 0.5, 0.732, 0.5, 0.5);
        gradient.setSpread(QGradient::PadSpread);
        gradient.setCoordinateMode(QGradient::ObjectBoundingMode);
        gradient.setColorAt(0, QColor(134, 149, 217, 245));
        gradient.setColorAt(1, QColor(255, 255, 255, 255));
        QBrush brush1(gradient);
        palette.setBrush(QPalette::Active, QPalette::Button, brush1);
        palette.setBrush(QPalette::Active, QPalette::Text, brush);
        palette.setBrush(QPalette::Active, QPalette::ButtonText, brush);
        QRadialGradient gradient1(0.5, 0.5, 0.732, 0.5, 0.5);
        gradient1.setSpread(QGradient::PadSpread);
        gradient1.setCoordinateMode(QGradient::ObjectBoundingMode);
        gradient1.setColorAt(0, QColor(134, 149, 217, 245));
        gradient1.setColorAt(1, QColor(255, 255, 255, 255));
        QBrush brush2(gradient1);
        palette.setBrush(QPalette::Active, QPalette::Base, brush2);
        QRadialGradient gradient2(0.5, 0.5, 0.732, 0.5, 0.5);
        gradient2.setSpread(QGradient::PadSpread);
        gradient2.setCoordinateMode(QGradient::ObjectBoundingMode);
        gradient2.setColorAt(0, QColor(134, 149, 217, 245));
        ...
        QRadialGradient gradient3(0.5, 0.5, 0.732, 0.5, 0.5);
        gradient3.setSpread(QGradient::PadSpread);
        gradient3.setCoordinateMode(QGradient::ObjectBoundingMode);
        gradient3.setColorAt(0, QColor(134, 149, 217, 245));
        ...
        QRadialGradient gradient4(0.5, 0.5, 0.732, 0.5, 0.5);
        gradient4.setSpread(QGradient::PadSpread);
        gradient4.setCoordinateMode(QGradient::ObjectBoundingMode);
        gradient4.setColorAt(0, QColor(134, 149, 217, 245));
        gradient4.setColorAt(1, QColor(255, 255, 255, 255));
        QBrush brush6(gradient4);
        palette.setBrush(QPalette::Inactive, QPalette::Base, brush6);
        QRadialGradient gradient5(0.5, 0.5, 0.732, 0.5, 0.5);
        gradient5.setSpread(QGradient::PadSpread);
        gradient5.setCoordinateMode(QGradient::ObjectBoundingMode);
        gradient5.setColorAt(0, QColor(134, 149, 217, 245));
...
#endif
        QBrush brush9(QColor(64, 64, 64, 255));
        brush9.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Disabled, QPalette::WindowText, brush9);
        QBrush brush10(QColor(50, 50, 50, 255));
        ...
        viewfinder_2 = new QCameraViewfinder(viewfinder);
        viewfinder_2->setObjectName(QStringLiteral("viewfinder_2"));
        viewfinder_2->setGeometry(QRect(0, 0, 883, 383));
        ...
        takeImageButton->setGeometry(QRect(40, 480, 901, 28));
        takeImageButton->setStyleSheet(QStringLiteral("color: rgb(0, 85, 255);"));
